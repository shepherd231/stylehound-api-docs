    ...
    case "guides":
      return {
        alternateDocVersions: {
          "0.0.1": { id: "home", path: "/guides/home", sidebar: "sidebar" },
          current: {
            id: "home",
            path: "/guides/next/home",
...
export default function DocsVersionDropdownNavbarItem({
  ...
  function versionItemToLink({
    ...
    return {
      ...
      isActive: () => version.name === activeVersion?.name,
